  ...
  const fetchArticles = async () => {
    try {
      const response = await axios.get(
        'https://newsdata.io/api/1/news?apikey=pub_165274cc54c2f29134707624b299ef9ea9bf6&country=in&language=en&q=ethereum OR bitcoin OR tether&from_date=2022-01-03&to_date=2023-01-20',
      );
